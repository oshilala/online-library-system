...
?>
<?php require_once 'editStudentVal.php'; ?>
...
<input class="form-control" type="text" name="mat" id="mat" value="<?php echo $row['matric_no']?>" readonly required>
</div>
</div>
...
<div class="form-group">
<a href="profile.php"><button type="button" class="btn btn-default">Back</button></a>
